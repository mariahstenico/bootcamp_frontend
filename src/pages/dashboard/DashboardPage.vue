    ...
    <template #default>
      <div class="dashboard">
        ...
        >
          <defs>
            <linearGradient
              id="ac3cc305-f6db-42f4-bbbd-32121ee27a74-654"
              x1="403.57"
              y1="833.5"
              x2="403.57"
              y2="218.16"
            ...
            <linearGradient
              id="ad14f186-b27f-416c-b629-0bafa2f1236e-655"
              x1="940.67"
              y1="825.72"
              x2="940.67"
              y2="263.72"
              xlink:href="#ac3cc305-f6db-42f4-bbbd-32121ee27a74-654"
            />
          </defs>
          ...
          <path
            ...
            transform="translate(-47.24 -58.63)"
            fill="url(#ac3cc305-f6db-42f4-bbbd-32121ee27a74-654)"
          />
          <path
          ...
          <path
            ...
            transform="translate(-47.24 -58.63)"
            fill="url(#ad14f186-b27f-416c-b629-0bafa2f1236e-655)"
          />
          <polygon
